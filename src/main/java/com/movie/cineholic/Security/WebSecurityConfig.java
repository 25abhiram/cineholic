...
import com.movie.cineholic.Security.Jwt.AuthEntryPointJwt; // Import for unauthorized access handler
import com.movie.cineholic.Security.Jwt.AuthTokenFilter; // Import for JWT token filter
import com.movie.cineholic.Security.Services.UserDetailsServiceImpl; // Import for user details service implementation
